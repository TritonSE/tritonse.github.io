      ...
      <div className="container">
        <div className="row black-text">
          <div className="col l6 s12 center">
            <Img fluid={data.nonprofits.childImageSharp.fluid} className="tse-header-apply-image"/>
            <h2>For Nonprofits</h2>
            <p className="tse-text-medium">Let TSE help your organization create the applications that will change the world!</p>
          ...
          <div className="col l6 s12 center">
            ...
            <Img fluid={data.students.childImageSharp.fluid} className="tse-header-apply-image"/>
            <h2>For Students</h2>
            <p className="tse-text-medium">Join our family and truly utilize your skills to give back to the community.</p>
