      ...
      <div className="container">
        <div className="row">
          <div className="col l6 s12 center">
            ...
            <p className="tse-text-large navy-text">Let TSE help your organization create the applications that will change the world!</p>
          ...
          <div className="col l6 s12 center">
            ...
            <p className="tse-text-large navy-text">Join our family and truly utilize your skills to give back to the community.</p>
