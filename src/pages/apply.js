        ...
        <div className="container">
          <div className="row">
            <div className="col l6 s12 center">
              ...
              <p className="tse-text-large navy-text tse-apply-subtitle">
                Let TSE help your organization create the applications that will
                change the world!
              </p>
              <Link to="/nonprofits" className="btn-large tse-nonprofit-button">
                Get Connected
              </Link>
            </div>
            <div className="col l6 s12 center">
              ...
              <p className="tse-text-large navy-text tse-apply-subtitle">
                Join our family and truly utilize your skills to give back to
                the community.
              </p>
              <Link to="/students" className="btn-large navy">
                Apply Now
              </Link>
            </div>
          </div>
