                ...
                <div>
                  {apps_active ? (
                    <p className="tse-text-medium">
                      Applications are open! Apply below. We will reach out to
                      you with more details if you are selected. Applications
                      close on 11:59 PDT, October 23rd, 2020.
                    </p>
                  ) : (
                  ...
                  <div className="card navy">
                    <div className="card-content white-text container">
                      ...
                      <p className="center">
                        ...
                        <b>tse.recruitment.ucsd@gmail.com</b> to prevent any
                      ...
                      <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="row">
                          <div className="input-field col s12">
                            ...
                            >
                              ...
                              <p>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span className="tse-text-small">
                                  Contribute code to meaningful projects while
                              ...
                              <p>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span className="tse-text-small">
                                  Design websites and mobile apps that will be
                                  widely adopted and heavily used by our
                                  clients.
                                </span>
                              </p>
                              <p>
                              ...
                              <p>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span className="tse-text-small">
                                  Lead a team of four to six students to
                                  complete a real project for a real client.
                                </span>
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="row">
                          <div className="input-field col s12">
                            <span className="white-text">
                              <b>Why do you want to join TSE?</b>
                            </span>
                            <textarea
                              name="why"
                              className="materialize-textarea white-text"
                        ...
                        <div className="row">
                          <div className="col s12 center-align">
                            <button
                              className="waves-effect tse-separation-small btn-large amber darken-1"
                              type="submit"
                              id="app-submit"
                            >
                              Submit
