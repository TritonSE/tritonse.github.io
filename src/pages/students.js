            ...
            <div className="tse-separation-medium col s12">
              <div className="card navy">
                <div className="card-content white-text container">
                  ...
                  <p className="center">Please whitelist the email address <b>tse.recruitment.ucsd@gmail.com</b> to prevent any recruitment-related emails from going to spam!</p>
