        ...
        <div className="container">
          <div className="row black-text">
            ...
            <div className="col l6 s12">
              <h5 className="tse-apply-subtitle navy-text">
                Partner up with Triton Software Engineering and we will work
                hand-in-hand to develop the technology that will turn your
                vision into a reality without costing you a penny.
              </h5>
              <p className="tse-text-medium tse-separation-small navy-text">
                If you have a proposal for an appropriate project, get in touch
                with us by emailing <b>tse@ucsd.edu</b>. We will work with you
                to deliver a solution that satisfies your needs.
              </p>
              <Link to="/projects#pastprojects" className="btn-large navy">
                See Past Projects
              </Link>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col l6 s12 center">
            <Img
              ...
              className="tse-nonprofits-mobile-image"
            ></Img>
            <h4 className="blue-text">Mobile Development</h4>
            <p className="tse-text-medium navy-text">
              Mobile applications allow us to bring powerful computing power to
              nearly anyone.
            </p>
          </div>
          <div className="col l6 s12 center">
            <Img
              ...
              className="tse-nonprofits-web-image"
            ></Img>
            <h4 className="dark-yellow-text">Web Development</h4>
            <p className="tse-text-medium navy-text">
              TSE can help you build web applications to take advantage of the
              power of the Internet in expanding your organization.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="row center white-text">
            <div className="col l4 s12">
              <div className="tse-apply-circle amber darken-1">
                <i className="fa fa-4x fa-globe white-text"></i>
              </div>
              <h4>Impact</h4>
            ...
            <div className="col l4 s12">
              <div className="tse-apply-circle amber darken-1">
                <i className="fa fa-4x fa-puzzle-piece white-text"></i>
              </div>
              <h4>Necessity</h4>
              <p className="tse-text-medium">
            ...
            <div className="col l4 s12">
              <div className="tse-apply-circle amber darken-1">
                <i className="fa fa-4x fa-calendar white-text"></i>
              </div>
              <h4>Scope</h4>
              <p className="tse-text-medium">
          ...
          <div className="row center white-text">
            <div className="col offset-l2 l4 s12">
              <div className="tse-apply-circle amber darken-1">
                <i className="fa fa-4x fa-object-group white-text"></i>
              </div>
              <h4>Technical Fit</h4>
              <p className="tse-text-medium">
                Is software & technological development integral to your
                project?
              </p>
            </div>
            <div className="col l4 s12">
              <div className="tse-apply-circle amber darken-1">
                <i className="fa fa-4x fa-eye white-text"></i>
              </div>
              <h4>Credibility</h4>
              <p className="tse-text-medium">
...
TSE’s structure consists of our board and about 7 project-based teams. Each team is made up of a development manager, product manager, 6 developers, and 2 UI/UX designers. Teams work independently of one another to create software for a specific non-profit they have been assigned to.
          ...
          <div className="col s12">
            <h4 className="navy-text">
              What resources does TSE have to ensure success?
            </h4>
            <p className="tse-text-medium navy-text">
              Our organization recruits some of the most hard-working,
              passionate, and brighest students at UC San Diego. Through
              effective leadership, frequent check-ins, and organized project
              timelines set with our clients and board, we can ensure that our
              combination of talent, dedication, and care will result in
              projects that benefit the nonprofits we work with.
            </p>
          </div>
        </div>
      </div>
