...
export default ({data}) => (
  <div>
    ...
    <div class="siimple-jumbotron tse-jumbotron-main siimple-jumbotron--large">
      ...
      <div class="siimple-jumbotron-subtitle">Pro-bono technical and web development services for non-profits</div>
      <div class="siimple-jumbotron-detail">We partner with non-profits to design and develop mobile and web applications for social good.</div>
    </div>
    <div class="siimple-content siimple-content--large">
      <div class="siimple-h2">About Us</div>
      ...
      <div class="siimple-h2">Get Involved</div>
      <div class="siimple-h5">Are you a UCSD student? Do you want to join?</div>
      <br/>
      <p class="siimple-p">
