...
<Gallery layout={[{ imageKey: "projects/uweast-community-kitchen/contact-page" }]} />

## About the Client

<Gallery layout={[{ width: 70 }, { imageKey: "clients/united_women_of_east_africa", width: 25 }]}>
...
<Gallery layout={[{}, { imageKey: "projects/uweast-community-kitchen/contact-page" }]} reverseOnSmallScreens>

Text on the left side or below. Lorem [ipsum](#) _dolor_ **sit** amet.

</Gallery>

<Gallery layout={[{ imageKey: "projects/uweast-community-kitchen/contact-page" }, {}]}>

Text on the right side or below. Lorem [ipsum](#) _dolor_ **sit** amet.
