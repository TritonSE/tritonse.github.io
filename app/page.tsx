...
Crafting digital solutions for nonprofit organizations in our community.
      ...
      <PaddedBox heading="Get Involved">
        {markdown`
As a powerhouse of 96 members, including our board, 49 developers, 19 UI/UX designers, and our TEST members, we are extremely collaborative here at Triton Software Engineering. In the past 8 years, we have provided software services pro bono for 25+ nonprofit organizations, and we are continuing to grow.
        `}
      </PaddedBox>
